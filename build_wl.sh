...
rm -rf wl_tool*
make -f linux_external.mk -j$(nproc --ignore=1)
mv wl_tool /app/wl_bin/dhd/wl_tool_x86

make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make -f linux_external.mk NL80211=1 -j$(nproc --ignore=1)
...
make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make  CC=aarch64-linux-gnu-gcc -f linux_external.mk -j$(nproc --ignore=1)
mv wl_tool /app/wl_bin/dhd/wl_tool_arm64

make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make  CC=aarch64-linux-gnu-gcc -f linux_external.mk LDFLAGS+="-static -pthread" -j$(nproc --ignore=1)
mv wl_tool /app/wl_bin/dhd/wl_tool_arm64s

make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make  CC=aarch64-linux-gnu-gcc -f linux_external.mk NL80211=1 -j$(nproc --ignore=1)
mv wl_tool_NL80211 /app/wl_bin/fmac/wl_tool_arm64

make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make  CC=aarch64-linux-gnu-gcc -f linux_external.mk NL80211=1 LDFLAGS+="-static -pthread" -j$(nproc --ignore=1)
...
make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make  CC=arm-linux-gnueabihf-gcc -f linux_external.mk -j$(nproc --ignore=1)
mv wl_tool /app/wl_bin/dhd/wl_tool_arm32

make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make  CC=arm-linux-gnueabihf-gcc -f linux_external.mk LDFLAGS+="-static -pthread" -j$(nproc --ignore=1)
mv wl_tool /app/wl_bin/dhd/wl_tool_arm32s

make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make  CC=arm-linux-gnueabihf-gcc -f linux_external.mk NL80211=1 -j$(nproc --ignore=1)
mv wl_tool_NL80211 /app/wl_bin/fmac/wl_tool_arm32

make clean -f linux_external.mk -j$(nproc --ignore=1)
rm -rf wl_tool*
make  CC=arm-linux-gnueabihf-gcc -f linux_external.mk NL80211=1 LDFLAGS+="-static -pthread" -j$(nproc --ignore=1)
